...
<script src="../plugins/LandingPage/bower_components/jquery/dist/jquery.min.js"></script>

<web:resource type="js-style" name="mojo/css/core.css" />
<web:resource type="style" name="mstr/pageLogin.css"/>
<web:resource type="style" name="../plugins/LandingPage/stylesheets/pageLogin.css"/>
...
--%>
<web:resource type="javascript" name="../plugins/LandingPage/javascripts/loginUtils.js"/>
<web:scriptlet>
   mstrApp = mstrApp || {};
