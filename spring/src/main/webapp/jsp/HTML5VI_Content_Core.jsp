...
var mstrApp = new mstrmojo.vi.VisualInsightApp({
        ...
        features: {
            <web:value type="features" name="create-analysis,create-folder,web-use-sharing-editor,edit-ive,warn-overwrite-flashVI,run-vi-flash,single-workingset,documents-design-mode,vi-unsupport-create-edit-rolap-report,vi-unsupport-create-edit-dummy-dataset,web-disable-manage-document-dataset,hide-objects-description,disable-save-dataset,disable-access-data-from-file,disable-access-data-from-database,disable-access-data-from-cloud-app,disable-reexecute-regular-report,disable-reexecute-view-report,disable-reexecute-cube-report,disable-dashboard-design,create-html-container,auto-add-history-list,web-is-schema-defined,sort-drill-paths,web-export-to-pdf-privilege,web-export-to-excel-privilege,web-export-to-csv-privilege,save-analysis,object-search,showPreviews"/>
        },
