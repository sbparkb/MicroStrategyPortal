...
function dTree(objName) {
	...
	this.icon = {
		root				: '../service/images/tree/folder.gif',
		//root				: '../../../docs/images/front/bg_folder_close.gif',
		folder				: '../service/images/tree/folder.gif',
		//folder			: '../../../docs/images/front/bg_folder_close.gif',
		folderOpen			: '../service/images/tree/folderopen.gif',
		//folderOpen		: '../../../docs/images/front/bg_folder_open.gif',
		node				: '../service/images/tree/page.gif',
		//node				: '../../../docs/images/front/bg_folder_close.gif',
		empty				: '../service/images/tree/empty.gif',
		line				: '../service/images/tree/line.gif',
		join				: '../service/images/tree/join.gif',
		joinBottom			: '../service/images/tree/joinbottom.gif',
		plus				: '../service/images/tree/plus.gif',
		plusBottom			: '../service/images/tree/plusbottom.gif',
		minus				: '../service/images/tree/minus.gif',
		minusBottom			: '../service/images/tree/minusbottom.gif',
		nlPlus				: '../service/images/tree/nolines_plus.gif',
		nlMinus				: '../service/images/tree/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		if (this.root.id == node.pid && !node.url) {
...
dTree.prototype.indent = function(node, nodeId) {
	...
	//if (this.root.id != node.pid) {
		...
		if (node._hc && !node.url) {
			...
			str += '" alt="" /></a>';
		} else if(node.url && node.url.indexOf('ftn_folder') >=0){
			str += '<a href="javascript: ' + this.obj + '.o(' + nodeId + ');"><img id="j' + this.obj + nodeId + '" src="';
			if (!this.config.useLines){
				str += (node._io) ? this.icon.nlMinus : this.icon.nlPlus;
			}
...
dTree.prototype.setCS = function(node) {
	...
	for (var n=0; n<this.aNodes.length; n++) {
		if (this.aNodes[n].pid == node.id || node.url == "") {
			node._hc = true;
		}
...
//Toggle Open or close
dTree.prototype.fo = function(id) {
	var cn = this.aNodes[id];
	this.nodeStatus(!cn._io, id, cn._ls);
	cn._io = !cn._io;
	if (this.config.closeSameLevel) {
